...
function Indicators:draw()    
    ...
    if plane.fuel > 0 then
        love.graphics.draw(images.needle, love.graphics.getWidth()-75, 80, angle, 0.15, 0.15, images.needle:getWidth()/2,
        images.needle:getHeight()/2)
    else
        love.graphics.draw(images.needle, love.graphics.getWidth()-75, 80, 0, 0.15, 0.15, images.needle:getWidth()/2,
        images.needle:getHeight()/2)
    end
    love.graphics.setColor(255, 255, 255)
